...
> = {
	motivational: [
		{
			text: "成功不是终点，失败也不是终结，唯有继续前行的勇气才是最重要的。",
			author: "温斯顿·丘吉尔",
		},
		{ text: "不要等待机会，而要创造机会。", author: "林肯" },
		{
			text: "生命中最伟大的光辉不在于永不坠落，而是坠落后总能再度升起。",
			author: "曼德拉",
		},
		{
	...
	philosophical: [
		...
		{
			text: "世界上只有一种英雄主义，那就是认清生活的真相后依然热爱生活。",
			author: "罗曼·罗兰",
		},
	...
	life: [
		...
		{
			text: "幸福不是得到你想要的一切，而是享受你现在拥有的一切。",
			author: "佚名",
		},
		{
...
> = {
	...
	search: {
		defaultEngine: "google" as SearchEngine,
		searchHistory: [],
		maxHistory: 10,

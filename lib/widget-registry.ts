...
export function getWidgetsByCategory(
	...
	return Object.values(WIDGET_METADATA).filter(
...
let widgetComponents: Partial<
	Record<WidgetType, ComponentType<BaseWidgetProps>>
> = {};
...
export function getWidgetComponent(
	type: WidgetType,
): ComponentType<BaseWidgetProps> | undefined {

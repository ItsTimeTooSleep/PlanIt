 ...
 */
export const NOTE_EDITOR_COLORS: {
	label: string;
	value: string;
	actualValue: string;
}[] = [
	{
		label: "黑色",
		value: NOTE_LINE_COLORS.black,
		actualValue: NOTE_EDITOR_COLORS_RGB.black,
	},
	{
		label: "红色",
		value: NOTE_LINE_COLORS.red,
		actualValue: NOTE_EDITOR_COLORS_RGB.red,
	},
	{
		label: "蓝色",
		value: NOTE_LINE_COLORS.blue,
		actualValue: NOTE_EDITOR_COLORS_RGB.blue,
	},
	{
		label: "绿色",
		value: NOTE_LINE_COLORS.green,
		actualValue: NOTE_EDITOR_COLORS_RGB.green,
	},
	{
		label: "黄色",
		value: NOTE_LINE_COLORS.yellow,
		actualValue: NOTE_EDITOR_COLORS_RGB.yellow,
	},
	{
		label: "紫色",
		value: NOTE_LINE_COLORS.purple,
		actualValue: NOTE_EDITOR_COLORS_RGB.purple,
	},
];

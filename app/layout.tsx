...
import { DesktopManager, TitleBar } from "@/components/desktop";
...
export const metadata: Metadata = {
	title: "PlanIt",
	description:
		"A personal time management web app for students. Plan your day, track completion, and review your time.",
	icons: {
		icon: [

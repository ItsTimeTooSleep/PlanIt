...
export function SettingsView() {
	...
	const [updateErrorDetail, setUpdateErrorDetail] = useState<string | null>(
		null,
	);
						...
						<div className="flex items-center gap-3">
							...
							<div className="flex-1">
								...
								<p className="text-xs text-muted-foreground">
									{appVersion
										? `${t.settings.versionPrefix || t.settings.versionPrefix}${appVersion}`
										: ""}
								</p>
							</div>
							{isDesktop && (

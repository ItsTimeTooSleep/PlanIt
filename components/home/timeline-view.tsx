...
import type { Language, Tag, Task } from "@/lib/types";
...
export function TimelineView({
	...
	return (
		<div className="relative flex-1 flex justify-center overflow-hidden px-4 py-3">
			<div
				className="w-full relative rounded-xl bg-card border border-border shadow-sm overflow-hidden"
					...
					>
						...
						>
							<div className="flex items-center gap-2 text-muted-foreground/60">
								...
								<span className="text-xs font-medium">{t.timeline.newDay}</span>
								<div className="w-12 h-px bg-muted-foreground/40" />
							</div>
						</div>
						...
						>
							<div className="flex items-center gap-2 text-muted-foreground/60">
								<div className="w-12 h-px bg-muted-foreground/40" />
								<span className="text-lg">🌙</span>
								<span className="text-xs font-medium">{t.timeline.dayEnd}</span>
								<div className="w-12 h-px bg-muted-foreground/40" />
							</div>
						</div>

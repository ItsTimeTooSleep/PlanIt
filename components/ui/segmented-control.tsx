...
export function SelectControl<T extends string | number>({
	...
	return (
		<SelectPrimitive.Root value={stringValue} onValueChange={handleValueChange}>
			...
			<SelectPrimitive.Portal>
				<SelectPrimitive.Content
					...
					sideOffset={4}
				>
					<SelectPrimitive.Viewport className="p-1 w-[var(--radix-select-trigger-width)] min-w-[100px]">
						{options.map((option) => (

...
export function CountdownWidget({
	...
	return (
		<div
			ref={containerRef}
			className={cn(
				"relative w-full h-full flex flex-col items-center justify-center bg-card overflow-hidden",
			...
			<div className="text-center space-y-1">
				...
				<div
					className={cn(
						"font-bold",
						daysFontSize,
						countdownInfo.isPast ? "text-primary" : "text-primary",
					)}
				>
					{countdownInfo.diffDays === 0 ? (
						"今天"
					...
					<div className="space-y-4">
						...
						<div className="space-y-2">
							...
							<Input
								...
								value={targetDate}
								onChange={(e) =>
									handleConfigChange("targetDate", e.target.value)
								}
								className="h-8 text-sm"
							/>
						</div>

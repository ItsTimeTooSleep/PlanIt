...
export function DateTimeWidget({
	...
	const dateDisplay = useMemo(() => {
		...
		if (lang === "zh") {
			...
			const weekday = configShowWeekday
				? ` 周${t.weekdays.short[now.getDay()]}`
				: "";
	...
	}, [lang, now, configShowDate, configShowWeekday, showYear, t, locale]);
	...
	return (
		...
		>
			...
			<div className={isVertical ? "" : "text-right"}>
				<p
					className={cn(
						"font-mono font-semibold text-primary tabular-nums leading-none",
						timeFontSize,
					)}
				>
					{timeDisplay}

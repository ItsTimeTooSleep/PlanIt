      ...
      {isMac ? (
        <>
          <div className="flex items-center gap-2 px-4">
            ...
            >
              {hoveredButton === 'close' && (
                <svg className="w-2 h-2 text-red-900" viewBox="0 0 12 12" fill="currentColor">
            ...
            >
              {hoveredButton === 'minimize' && (
                <svg className="w-2 h-2 text-yellow-900" viewBox="0 0 12 12" fill="currentColor">
            ...
            >
              {hoveredButton === 'maximize' && (
                isMaximized ? (
                  <svg className="w-2 h-2 text-green-900" viewBox="0 0 12 12" fill="currentColor">
                  ...
                  <svg className="w-2 h-2 text-green-900" viewBox="0 0 12 12" fill="none" stroke="currentColor">

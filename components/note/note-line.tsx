...
export function NoteLineComponent({
	...
	const color = isPreview
		? CSS_NOTE_LINE_COLORS.blue
		: NOTE_LINE_COLORS[line.color];
		...
		>
			...
			<line
				...
				className={cn(
					isPreview
						? "pointer-events-none"
						: "pointer-events-auto cursor-pointer transition-all hover:stroke-3 hover:opacity-80",
				)}

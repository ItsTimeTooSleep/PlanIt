		...
		<div className={cn("relative group", className)}>
			<div
				...
				style={{
					...
					boxShadow: isFocused
						? "0 4px 6px -1px color-mix(in srgb, var(--warning) 10%, transparent)"
						: undefined,
				}}
			>
				...
				<div className="p-2">
					{justSaved ? (
						...
						<Textarea
							...
							placeholder={t.note.quickNotePlaceholder}
							className={cn(
